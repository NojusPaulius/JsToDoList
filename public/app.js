...
/* harmony import */ var _modules_createListRow__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/createListRow */ "./src/modules/createListRow.js");
/* harmony import */ var _modules_checkButton__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/checkButton */ "./src/modules/checkButton.js");




(0,_modules_saveToLocal__WEBPACK_IMPORTED_MODULE_1__["default"])();
(0,_modules_createListRow__WEBPACK_IMPORTED_MODULE_2__["default"])();
(0,_modules_checkButton__WEBPACK_IMPORTED_MODULE_3__["default"])();

/***/ }),

/***/ "./src/modules/checkButton.js":
/*!************************************!*\
  !*** ./src/modules/checkButton.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var checkButton = function checkButton() {
  var checkButton = document.querySelector(".toDoList__check-button");
  var task = document.querySelector(".toDoList__row-text");
...
var createListRow = function createListRow() {
  var dataArray = JSON.parse(localStorage.getItem("dataArray"));
  var tableBody = document.querySelector(".toDoList-body");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createListRow);
...
var saveToLocal = function saveToLocal(e) {
  ...
  saveButton.addEventListener("click", function () {
    var task = document.querySelector(".textInput").value;
    var priority = document.querySelector(".priorityInput").value;
    var dueDate = document.querySelector(".dueDateInput").value;
    var dataArray = JSON.parse(localStorage.getItem("dataArray")) || [];
    var toDoListObject = {
      task: task,
      priority: priority,
    ...
    if (toDoListObject.task !== "" || toDoListObject.priority !== "" || toDoListObject.dueDate !== "") {
